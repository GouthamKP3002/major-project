      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                Welcome back, {userProfile?.designation} {userProfile?.name}!
              </h2>
              <p className="text-gray-600">
                Employee ID: {userProfile?.employeeId} | Department: {userProfile?.department}
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Teaching Subjects</dt>
                      <dd className="text-lg font-medium text-gray-900">{userProfile?.subjects?.length || 0}</dd>
                    </dl>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Classes Today</dt>
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Subjects Teaching</h3>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <button className="bg-blue-50 hover:bg-blue-100 p-4 rounded-lg text-center transition duration-200">
                  ...
                  <span className="text-sm font-medium text-blue-900">Manage Courses</span>
                </button>
                ...
                <button className="bg-yellow-50 hover:bg-yellow-100 p-4 rounded-lg text-center transition duration-200">
                  ...
                  <span className="text-sm font-medium text-yellow-900">Grade Assignments</span>
                </button>
              </div>
            </div>
          </div>
